                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input id="Transfer" name="paymentMethod" type="radio" class="custom-control-input" checked required>
                                    <label class="custom-control-label" for="Transfer">Bank Transfer</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input id="paystack" name="paymentMethod" type="radio" class="custom-control-input" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3 mt-5">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="images/payment-icon/tf.png" alt=""></li>
                                            <li><img class="img-fluid" src="images/payment-icon/paystack.png" alt=""></li>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="ml-4 mb-2 small">(Within 24hrs)</div>                                    
